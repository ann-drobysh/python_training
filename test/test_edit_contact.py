...
# personal_name parameter value format: Firstname Lastname
    ...
    app.contact.edit_contact(Contact(personal_name="Anna Test", firstname="Test edit", middlename="Midtest edit", lastname="Lasttest edit", nickname="Nickname test edit", title="Mrs edit", company="Test Company edit", street="5th Avenue edit",
