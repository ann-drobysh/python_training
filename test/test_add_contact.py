...
def test_add_new_contact(app):
    ...
    app.contact.add_new_contact(Contact(firstname="Test", middlename="Midtest", lastname="Lasttest", nickname="Nickname test", title="Mrs", company="Test Company", street="5th Avenue",
