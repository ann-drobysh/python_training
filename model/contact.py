...
class Contact:
    ...
    def __repr__(self):
        return "%s:%s:%s:%s:%s:%s:%s:%s:%s:%s" % (self.id, self.firstname, self.lastname, self.middlename, self.street,
                                self.homephone, self.mobilephone, self.email, self.address2, self.phone2)
